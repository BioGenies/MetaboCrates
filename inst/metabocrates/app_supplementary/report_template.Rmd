...
```{r, eval=!is.null(attr(params[["dat"]], "completed"))}
...
if(!is.null(cor_heatmap_both)){
  cor_heatmap_cap_both <- "Heatmap of correlations before and after imputation (up to 10 chosen metabolites visible)."
...
```{r, eval=!is.null(attr(params[["dat"]], "completed")), fig.height=4, fig.width=5, fig.cap=cor_heatmap_cap_both, fig.align='center', fig.pos="H", results=ifelse(exists("cor_heatmap_results_both"), cor_heatmap_results_both, "show")}
...
if(!is.null(cor_heatmap)){
  cor_heatmap_cap <- "Heatmap of correlations after imputation (up to 10 chosen metabolites visible)."
...
```{r, eval=!is.null(attr(params[["dat"]], "cv")), fig.height=4, fig.width=5, fig.cap=cor_heatmap_cap, fig.align='center', fig.pos="H", results=ifelse(exists("cor_heatmap_results"), cor_heatmap_results, "show")}
