...
test_that("All the values are completed", {
...
test_that("Proper LOD values were imputed", {
...
test_that("Proper LLOQ values were imputed", {
  expect_equal(completed[19, 22], 0.4)
  expect_equal(completed[19, 24], 0.1)
})

test_that("Proper ULOQ values were imputed", {
